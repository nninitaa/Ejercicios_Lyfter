...
for i in range(len(numbers)): #O(n^2) Hay varios ciclos anidados, por lo que se multiplican sus tiempos de ejecución
    for j in range(len(numbers) - 1): #O(n^2) El ciclo se ejecuta n veces n * n = n^2
...
print(numbers) #O(1) Esto va a imprimir la lista ordenada de menor a mayor
...
for i in range(len(numbers)): #O(n^2) Hay varios ciclos anidados
    for j in range(len(numbers) - 1, 0, -1): #O(n^2) El ciclo se ejecuta n veces n * n = n^2
...
print(numbers) #O(1) Esto imprime la lista y lee el codigo de derecha a izquierda, pero el resultado es el mismo que el ejercicio anterior
...
def check_if_lists_have_an_equal(list_a, list_b): 
	for element_a in list_a: #O(n^2) El ciclo se ejecuta n veces n * n = n^2
		for element_b in list_b: #O(n^2) El ciclo se ejecuta n veces n * n = n^2
...
def generate_list_trios(list_a, list_b, list_c): 
	...
	for element_a in list_a: #O(n^2) El ciclo se ejecuta n veces n * n = n^2
		for element_b in list_b: #O(n^2) El ciclo se ejecuta n veces n * n = n^2
			for element_c in list_c: #O(n^2) El ciclo se ejecuta n veces n * n = n^2	
